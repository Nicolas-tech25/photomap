      ...
      <View style={estilos.container}>
        <ScrollView>
          <Text style={estilos.titulo}>
            Política de Privacidade para o app PhotoMap
          </Text>

          <Text style={estilos.texto}>
            A sua privacidade é importante para nós. É política do PhotoMap
            respeitar a sua privacidade em relação a qualquer informação sua que
            possamos coletar no site PhotoMap, e outros sites que possuímos e
            operamos.
          </Text>
          ...
          <Text style={estilos.texto}>
            ...
            informação que o PhotoMap oferece no site e com caráter
          ...
          <Text style={estilos.texto}>
            ...
            (softwares) do PhotoMap, de seus fornecedores ou terceiros,
